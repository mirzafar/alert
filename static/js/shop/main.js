(function ($) {
    ...
    $("#slider-range").slider({
        ...
        slide: function (event, ui) {
            ...
            $("#js-start-price").val(ui.values[0])
            $("#js-stop-price").val(ui.values[1])
        }
    });
    $("#js-start-price").val($("#slider-range").slider("values", 0))
    $("#js-stop-price").val($("#slider-range").slider("values", 1))
